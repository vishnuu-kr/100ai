...
async def run_company(goal: str) -> str:
    ...
    team_d_task = (
        ...
        "create ALL content assets needed to get the maximum number of users to this website:\n"
        "1. 5 viral X/Twitter posts (with hooks from real trending topics)\n"
        "2. 1 complete Twitter/X thread (10 tweets)\n"
        "3. 3 LinkedIn posts (B2B angle, authority-building)\n"
        "4. 1 Instagram carousel (8 slides with copy)\n"
        "5. 1 long-form blog article (1000+ words, SEO-optimized for trending keywords)\n"
        "6. 1 high-converting landing page hero section (H1, subheadline, 3 bullets, CTA)\n"
        "7. 5-email welcome drip sequence\n"
        "8. 3 Reddit posts (community-native, educational, not promotional)\n"
        "9. 2 Product Hunt launch assets (tagline + description)\n"
        "10. 3 YouTube video title + thumbnail concept ideas\n"
    ...
    master_synthesis_prompt = (
        ...
        f"TEAM G (STRATEGY — ranked action plan):\n{strategy_report[:1200]}\n\n"
        "=== YOUR TASK: WRITE THE PERFECT USER ACQUISITION PLAN ===\n\n"
        "You have live trend data, real Reddit discussions, competitor analysis, audience language, and content drafts above.\n"
        "Write the DEFINITIVE plan to get the most users possible. Be EXTREMELY SPECIFIC — no generic advice.\n\n"
        "## 1. EXECUTIVE SUMMARY\n"
        "3 sentences: what is the product, who is the exact audience, and what is the #1 channel to get users.\n\n"
        "## 2. REDDIT STRATEGY (most important — this gets the most users)\n"
        "List EXACTLY which subreddits to post in (e.g. r/SaaS, r/ChatGPT, r/artificial) with reasoning.\n"
        "For each subreddit, write the EXACT post title and opening paragraph that will perform best based on the live trends found.\n"
        "Include: best time to post (day + hour), post format (text/link/image), flair to use if applicable.\n"
        "Write at least 5 ready-to-post Reddit posts with full titles and opening lines.\n\n"
        "## 3. 7-DAY CONTENT CALENDAR\n"
        "Day-by-day table: Platform | Post Title/Hook | Post Type | Best Time | Expected Reach\n"
        "Must include Reddit posts EVERY day. Be specific — write the actual hook/title, not a placeholder.\n\n"
        "## 4. HOW TO GET THE FIRST 1,000 USERS\n"
        "Step-by-step numbered list. Each step must be specific, actionable, and time-bound.\n"
        "Include which communities to engage, what to say, what to offer.\n\n"
        "## 5. TOP 3 THINGS TO DO RIGHT NOW TODAY\n"
        "The 3 highest-impact actions. Each must be completable in under 2 hours.\n\n"
        "## 6. OTHER PLATFORMS\n"
        "X/Twitter: exact tweet text (2 ready-to-post tweets)\n"
        "LinkedIn: exact post angle and opening sentence\n"
        "Product Hunt: exact tagline and description for launch\n\n"
        "## 7. SEO QUICK WINS\n"
        "Top 5 keywords + content format to rank for them + estimated difficulty (low/medium/high)\n\n"
        "## 8. RISK FLAGS\n"
